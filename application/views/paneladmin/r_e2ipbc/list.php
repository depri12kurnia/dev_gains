        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    Data Submission & Weighted Evaluation
                </h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="data_evaluation" class="table table-bordered table-striped w-100">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Title</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea name="title" placeholder="Title" class="form-control" rows="4" readonly></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script>
    ...
    function viewSubmission(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/category/e2ipbc/ajax_view/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    $(document).ready(function() {
        ...
        if (!$.fn.DataTable.isDataTable('#data_evaluation')) {
            table = $('#data_evaluation').DataTable({
                "processing": true,
                "serverSide": true,
                "order": [], // Initial order kosong
                "ajax": {
                    "url": "<?php echo site_url('admin/category/e2ipbc/ajax_list') ?>",
                    "type": "POST",
                    "data": function(d) {
