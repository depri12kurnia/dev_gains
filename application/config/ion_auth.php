...
/*
 ...
 | Please customize
 */
$config['session_hash'] = '10cc8332c82e3f96f1bf57e798ab6a18b894e65b';
...
$config['email_config'] = array(
	'protocol'  => 'smtp',  // Bisa diubah ke 'sendmail' jika menggunakan sendmail
	// 'smtp_host' => 'ssl://srv76.niagahoster.com', // Ganti dengan SMTP provider
	// 'smtp_port' => 465,  // Port untuk SSL (587 untuk TLS)
	// 'smtp_user' => 'noreply@poltekkesjakarta3.ac.id',  // Email pengirim
	// 'smtp_pass' => 'Jak#17415jkt3',  // Password email pengirim
	// 'mailtype'  => 'html',
	// 'charset'   => 'utf-8',
	// 'newline'   => "\r\n"

	'smtp_host' => 'ssl://smtp.gmail.com', // Ganti dengan SMTP provider
	'smtp_port' => 465,  // Port untuk SSL (587 untuk TLS)
	'smtp_user' => 'noreply@poltekkesjakarta3.ac.id',  // Email pengirim
	'smtp_pass' => 'Jak#17415jkt3',  // Password email pengirim
	'mailtype'  => 'html',
