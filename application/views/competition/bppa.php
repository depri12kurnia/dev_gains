    ...
    <div class="container" style="max-width:1000px;">
        ...
        $competitionData = array(
            ...
            'comp-bppa' => array(
                ...
                'icon' => "book-open",
                'format' => "Recognition of scientific articles published in reputable journals (within the last three years).",
        ...
        $active_type = (isset($_GET['type']) && isset($competitionData[$_GET['type']])) ? $_GET['type'] : 'comp-bppa';
