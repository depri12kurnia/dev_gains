<!-- PAGE: ABOUT -->
<div id="page-about" class="page-section bg-gray-50 active">
    <div class="container">
            ...
            <div class="lg-col-8">
                <div class="bg-white rounded-2xl shadow-sm border p-8 mb-8">
                    ...
                    <div class="text-gray-600 text-lg" style="display: flex; flex-direction: column; gap: 1rem;">
                        <p>The advancement of science and technology in the health sector, along with the dynamics of global challenges—particularly the rising burden of non-communicable diseases and the need for comprehensive women’s health—requires lecturers and researchers not only to produce academically rigorous research but also to develop innovations that have tangible impacts on healthcare practices, public policy, and community empowerment.</p>
